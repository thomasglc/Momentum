<template>
  <div class="bg-stone-100" style="min-height: 100dvh; padding-top: env(safe-area-inset-top)">
    ...
    <!-- Bottom Tab Nav -->
    <nav v-if="!isLoginPage && appStore.ready" class="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-stone-200" style="padding-bottom: calc(env(safe-area-inset-bottom) + 6px); transform: translateZ(0); -webkit-transform: translateZ(0)">
