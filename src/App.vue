<template>
  <div class="bg-stone-100 min-h-full" style="padding-top: env(safe-area-inset-top)">
    ...
    <!-- Bottom Tab Nav -->
    <nav v-if="!isLoginPage" class="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-stone-200" style="padding-bottom: env(safe-area-inset-bottom); transform: translateZ(0); -webkit-transform: translateZ(0)">
